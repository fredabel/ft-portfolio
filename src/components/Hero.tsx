...
const Hero: React.FC = () => {
    ...
    return (
        <div className="relative isolate px-6 lg:px-8">
            ...
            <div className="mx-auto max-w-3xl pt-32 pb-20 sm:py-40 lg:py-40">
                <div className="hidden sm:mb-8 sm:flex sm:justify-start">
                    {/* <img src={'./images/ft_profile.jpeg'} className="w-20 h-20 rounded-full" alt="Frederic Tuazon Profile" /> */}
