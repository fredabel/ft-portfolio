...
const Projects : React.FC = () =>{
    const features = [
  {
    ...
    description:
      'A responsive UI using React.js, Bootstrap, and Axios for API integration, ensuring a seamless user experience across devices.',
  ...
  },
  {
    ...
    description:
      'A RESTful API using Flask, SQLAlchemy, and Marshmallow to streamline service ticket tracking, status updates, and role-based access for mechanics and customers.',
    icon: LockClosedIcon,
  ...
  },
  {
    ...
    description:
      'A responsive e-commerce frontend using React.js to display products, categories, and details fetched from the FakeStore API.',
    icon: ArrowPathIcon,
  ...
  },
  {
    ...
    description:
      'A React-based application that allows users to test their knowledge by answering quiz questions fetched from the Open Trivia Database API.',
    icon: ArrowPathIcon,
